...
namespace Tests.Wasm
{
    ...
    public class Traversal_TreeTraversal_Children1 : JQTest
    {
        ...
        {
            tc.Append(JQueryBox.FromHtml("<div></div><div></div><span></span>"));
    ...
    public class Traversal_TreeTraversal_Closest : JQTest
    {
        public override void Run()
        {
            tc.Append(JQueryBox.FromHtml("<div></div>"));
    ...
    public class Traversal_TreeTraversal_Next1 : JQTest
    {
        public override void Run()
        {
            ...
            tc.Append(child);
            tc.Append(JQueryBox.FromHtml("<div class='next'></div><div class='next2'></div>"));
            var t = child.Next();
    ...
    public class Traversal_TreeTraversal_NextAll2 : JQTest
    {
        public override void Run()
        {
            var child = JQueryBox.FromHtml("<div></div>");
            tc.Append(child);
            tc.Append(JQueryBox.FromHtml("<div class='next'></div><div class='next2'></div><div class='next'>"));
    ...
    public class Traversal_TreeTraversal_PrevAll1 : JQTest
    {
        public override void Run()
        {
            tc.Append(JQueryBox.FromHtml("<div class='x'></div><div class='y'></div><div class='x'></div><div class='z'></div>"));
            var child = tc.Find(".z");
    ...
    public class Traversal_TreeTraversal_PrevAll2 : JQTest
    {
        public override void Run()
        {
            tc.Append(JQueryBox.FromHtml("<div class='x'></div><div class='y'></div><div class='z'></div>"));
            var child = tc.Find(".z");
            var t = child.PrevAll();
            Assert(t.Length == 2);
        }
    ...
    public class Traversal_TreeTraversal_PrevUntil1 : JQTest
    {
        public override void Run()
        {
            tc.Append(JQueryBox.FromHtml("<div class='w'></div><div class='x'></div><div class='y'></div><div class='x'></div><div class='z'></div>"));
            var child = tc.Find(".z");
